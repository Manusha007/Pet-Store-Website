...
let items = {
    food: [{
                ...
                img: 'pics/shop/food/pedigree.png',
                price: 3000
            }, 
            {
                name: 'Drools Puppy Food',
                img: 'pics/shop/food/drools.jpg',
                price: 2000
            }],
    toy: [{
            name: 'Rubber Chewing Dog Toy',
            img: 'pics/shop/toy/rubber.jfif',
            price: 550
        }, 
        {
            name: 'Chewy Rubber Bone Dog Toy',
            img: 'pics/shop/toy/bone.jpg',
            price: 700
        }],
    med: [{
            name: 'Himalaya Himpyrin',
            img: 'pics/shop/med/himpyrin.jpg',
            price: 2400
        }, 
        {
            name: 'Ultramax Syrup',
            img: 'pics/shop/med/ultramax.png',
            price: 3200
        }]
}
