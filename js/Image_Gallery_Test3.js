...
function displayImage(pic){
    switch (pic) {
        case "img1":
            ...
            document.getElementById("description").innerHTML = document.getElementById("Dachshund_Dc").innerHTML;
            imgesposition();
            break;
        case "img2":
            document.getElementById("imgViewerWDescription").style.display = "block";
            document.getElementById("imageViewer").innerHTML = document.getElementById("pic2").innerHTML;
            document.getElementById("description").innerHTML = document.getElementById("Beagle_Dc").innerHTML;
            imgesposition();
            break;
        case "img3":
            document.getElementById("imgViewerWDescription").style.display = "block";
            document.getElementById("imageViewer").innerHTML = document.getElementById("pic3").innerHTML;
            document.getElementById("description").innerHTML = document.getElementById("GermanShepherd_Dc").innerHTML;
            imgesposition();
            break;
        case "img4":
            document.getElementById("imgViewerWDescription").style.display = "block";
            document.getElementById("imageViewer").innerHTML = document.getElementById("pic4").innerHTML;
            document.getElementById("description").innerHTML = document.getElementById("LabradorRetriever_Dc").innerHTML;
            imgesposition();
            break;
        case "img5":
            document.getElementById("imgViewerWDescription").style.display = "block";
            document.getElementById("imageViewer").innerHTML = document.getElementById("pic5").innerHTML;
            document.getElementById("description").innerHTML = document.getElementById("BullDog_Dc").innerHTML;
            imgesposition();
            break;
    }
}
